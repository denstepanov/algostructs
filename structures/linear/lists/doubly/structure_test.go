...
func TestFindByIndex(t *testing.T) {
	...
	if node != list.Tail() {
		t.Fatal(fmt.Printf("DLList.FindByIndex() %s", structures.MethodNotWorking))
	}
}
...
func TestFindByValue(t *testing.T) {
	...
	if nodes[0] != list.Tail() {
		t.Fatal(fmt.Printf("DLList.FindByValue() %s", structures.MethodNotWorking))
	}
}

func TestInsertTail(t *testing.T) {
	if list.Len() == 0 {
		t.Fatal(fmt.Printf("DLList.InsertTail() %s", structures.MethodNotWorking))
	}
}
...
func TestClear(t *testing.T) {
	...
	if !list.IsEmpty() {
		t.Fatal(fmt.Printf("DLList.Clear() %s", structures.MethodNotWorking))
	}
...
func TestToSlice(t *testing.T) {
	...
	if len(listAsSlice) != list.Len() {
		t.Fatal(fmt.Printf("DLList.ToSlice() %s", structures.MethodNotWorking))
	}
}
...
func TestInsertBefore(t *testing.T) {
	...
	if list.Len() == oldLen {
		t.Fatal(fmt.Printf("DLList.InsertBefore() %s", structures.MethodNotWorking))
	}
}
...
func TestInsertAfter(t *testing.T) {
	...
	if list.Len() == oldLen {
		t.Fatal(fmt.Printf("DLList.InsertAfter() %s", structures.MethodNotWorking))
	}
}
